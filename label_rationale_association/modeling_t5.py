...
"""
    A modified version of the Python file of the same name from Huggingface Transformers v2.9.1 (https://github.com/huggingface/transformers/blob/7cb203fae4e7964e9e99400b375d660ebce765ee/src/transformers/modeling_t5.py)
    Modifications made to the forward functions of the T5ForConditionalGeneration and the T5Stack classes to accept noising and variance.
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    Examples::
        ...
        if encoder_outputs is None:
            ...
            raise Exception("This condition should not be triggered during noisy inference.")
            encoder_outputs = self.encoder(
                input_ids=input_ids,
                attention_mask=attention_mask,
                inputs_embeds=inputs_embeds,
